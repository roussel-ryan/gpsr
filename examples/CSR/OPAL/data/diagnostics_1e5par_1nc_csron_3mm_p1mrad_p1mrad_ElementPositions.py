...
def exportVTK():
    ...
    fh = open('diagnostics_1e5par_1nc_csron_3mm_p1mrad_p1mrad_ElementPositions.vtk','w')
...
def exportWeb(bgcolor):
    ...
    fh = open('diagnostics_1e5par_1nc_csron_3mm_p1mrad_p1mrad_ElementPositions.html','w')
    fh.write(index)
    fh.close()
...
def projectToPlane(normal):
    fh = open('diagnostics_1e5par_1nc_csron_3mm_p1mrad_p1mrad_ElementPositions.gpl','w')
