...
def exportVTK():
    ...
    fh = open('dogleg_1e4par_1nc_csron_3mm_p1mrad_p1mrad_ElementPositions.vtk','w')
...
def exportWeb(bgcolor):
    ...
    fh = open('dogleg_1e4par_1nc_csron_3mm_p1mrad_p1mrad_ElementPositions.html','w')
    fh.write(index)
    fh.close()
...
def projectToPlane(normal):
    fh = open('dogleg_1e4par_1nc_csron_3mm_p1mrad_p1mrad_ElementPositions.gpl','w')
