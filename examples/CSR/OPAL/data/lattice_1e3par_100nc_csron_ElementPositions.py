...
def exportVTK():
    ...
    fh = open('lattice_1e3par_100nc_csron_ElementPositions.vtk','w')
...
def exportWeb(bgcolor):
    ...
    fh = open('lattice_1e3par_100nc_csron_ElementPositions.html','w')
    fh.write(index)
    fh.close()
...
def projectToPlane(normal):
    fh = open('lattice_1e3par_100nc_csron_ElementPositions.gpl','w')
