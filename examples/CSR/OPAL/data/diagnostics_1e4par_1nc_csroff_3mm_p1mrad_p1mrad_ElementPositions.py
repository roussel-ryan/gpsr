...
vertices = []
numVertices = [48]
vertices_base64 = ""
...
decoration = [[ -0.223551, -0.000000, 0.498843, 0.276449, 0.000000, 0.498843, 0.000000, 0.000000, 0.050000, 0.000000, 0.000000, 0.300000, 0.052898, 0.000000, 0.600000, 0.143891, 0.000000, 0.850000]]
...
def exportVTK():
    ...
    fh = open('diagnostics_1e4par_1nc_csroff_3mm_p1mrad_p1mrad_ElementPositions.vtk','w')
...
def exportWeb(bgcolor):
    ...
    fh = open('diagnostics_1e4par_1nc_csroff_3mm_p1mrad_p1mrad_ElementPositions.html','w')
    fh.write(index)
    fh.close()
...
def projectToPlane(normal):
    fh = open('diagnostics_1e4par_1nc_csroff_3mm_p1mrad_p1mrad_ElementPositions.gpl','w')
